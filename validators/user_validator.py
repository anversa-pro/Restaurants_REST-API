...
class NewUser:
    ...
    def validate_new_user(*args):
        ...
        if user.username == username:
            raise UserAlreadyCreatedError("the email already created access you can log in to.")

        raise EmailAlreadyAssociatedError("the email already exists associated with another username.")
